        ...
        <main class="one column row">
            <form class="ui form five wide centered floated column" action="LoginController" method="post">
                ...
                <div class="ui bottom attached segment">                  
                    ...
                    <jstl:if test="${newyear}">
                        <div class="ui bottom attached orange icon message">
                            <i class="notched circle loading icon"></i>
                            <div class="header">
                                Ενδέχεται να υπάρξει μικρή καθυστέρηση στη σύνδεση λόγω αλλαγής του έτους.
                            </div>
                            <p>
                                Σε τέτοια περίπτωση, παρακαλούμε περιμένετε, <b>χωρίς να κλείσετε τη σελίδα.</b>
                            </p>
                        </div>
                    </jstl:if> 
                    <jstl:if test="${login_retry}">
